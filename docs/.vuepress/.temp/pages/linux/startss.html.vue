...
</code></pre></div><h1 id="_3、nginx-php" tabindex="-1"><a class="header-anchor" href="#_3、nginx-php" aria-hidden="true">#</a> 3、nginx+php</h1>
...
<h1 id="_4、数据库" tabindex="-1"><a class="header-anchor" href="#_4、数据库" aria-hidden="true">#</a> 4、数据库</h1>
...
</code></pre></div><h1 id="_5、zabbix-服务端" tabindex="-1"><a class="header-anchor" href="#_5、zabbix-服务端" aria-hidden="true">#</a> 5、zabbix-服务端</h1>
<p>安装zabbix yum源</p>
...
</code></pre></div><h1 id="_6、zabbix前端页面准备" tabindex="-1"><a class="header-anchor" href="#_6、zabbix前端页面准备" aria-hidden="true">#</a> 6、zabbix前端页面准备</h1>
...
</code></pre></div><h1 id="_7、安装zabbix-zabbix前端页面连接数据库与zabbix-server" tabindex="-1"><a class="header-anchor" href="#_7、安装zabbix-zabbix前端页面连接数据库与zabbix-server" aria-hidden="true">#</a> 7、安装zabbix(zabbix前端页面连接数据库与zabbix-server)</h1>
<p>php最后的配置</p>
...
</code></pre></div><h1 id="zabbix-agent-vs-agent2" tabindex="-1"><a class="header-anchor" href="#zabbix-agent-vs-agent2" aria-hidden="true">#</a> Zabbix agent vs agent2</h1>
<table>
<thead>
<tr>
<th></th>
...
<h1 id="zabbix-agent-2-监控流程" tabindex="-1"><a class="header-anchor" href="#zabbix-agent-2-监控流程" aria-hidden="true">#</a> Zabbix Agent[2]监控流程</h1>
<p>Linux安装与配置客户端</p>
<p>web添加与配置主机</p>
