...
</code></pre></div><p>访问地址</p><table><thead><tr><th>应用</th><th>访问地址</th><th>备注</th></tr></thead><tbody><tr><td>prometheus</td><td>http://10.0.0.112:9090</td><td>无用户和密码</td></tr><tr><td>监控指标</td><td>http://10.0.0.112:9090/metrics</td><td></td></tr></tbody></table><h4 id="_2-2-安装alertmanager" tabindex="-1"><a class="header-anchor" href="#_2-2-安装alertmanager" aria-hidden="true">#</a> 2.2 安装alertmanager</h4><p>下载alertmanager</p>`,22),m={href:"https://prometheus.io/download/",target:"_blank",rel:"noopener noreferrer"},g=e(`<ul><li>注：在root用户下执行</li></ul><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 下载alertmanager二进制压缩包</span>
...
</code></pre></div>`,27);function _(v,f){const n=p("ExternalLinkIcon");return r(),c("div",null,[i,s("p",null,[s("a",d,[a("官网下载地址"),t(n)]),a("，获取最新下载URL")]),h,s("p",null,[s("a",m,[a("官网下载地址"),t(n)]),a("，获取最新下载URL")]),g,s("p",null,[a("除了通过使用“up”表达式查询当前所有Instance的状态以外，还可以通过Prometheus UI中的"),s("a",k,[a("Targets"),t(n)]),a("页面查看当前所有的监控采集任务，以及各个任务下所有实例的状态。")]),b])}const q=o(u,[["render",_],["__file","index.html.vue"]]);export{q as default};
