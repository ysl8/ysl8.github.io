...
</code></pre></div><h2 id="_3、nginx-php" tabindex="-1"><a class="header-anchor" href="#_3、nginx-php" aria-hidden="true">#</a> 3、nginx+php</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>systemctl <span class="token builtin class-name">enable</span> nginx php72-php-fpm
...
?&gt;
EOF</span>
</code></pre></div><p>浏览器访问<code>zbx.oldboylinux.cn/info.php</code></p><h2 id="_4、数据库" tabindex="-1"><a class="header-anchor" href="#_4、数据库" aria-hidden="true">#</a> 4、数据库</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@zbx ~<span class="token punctuation">]</span><span class="token comment"># yum install -y mariadb-server</span>
...
</code></pre></div><h2 id="_6、zabbix前端页面准备" tabindex="-1"><a class="header-anchor" href="#_6、zabbix前端页面准备" aria-hidden="true">#</a> 6、zabbix前端页面准备</h2><p><code>https://www.zabbix.com/cn/download_sources</code></p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#使用源码包</span>
